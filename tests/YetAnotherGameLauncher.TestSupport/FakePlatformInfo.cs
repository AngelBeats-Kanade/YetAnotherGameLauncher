...
/// <summary>平台信息假实现：IsLinux 与 NVIDIA 探测结果可控，让测试在任意 OS 上确定性地走指定平台分支。</summary>
public sealed class FakePlatformInfo(bool isLinux, bool nvidiaGpuPresent = false) : IPlatformInfo
{
    ...
    /// <summary>NVIDIA 显卡探测结果（影响 Proton 推荐环境变量）。</summary>
